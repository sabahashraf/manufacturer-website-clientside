...
const Support = () => {
  return (
    <section>
      <h2 className="text-4xl text-center font-bold mb-12 mt-16">
      ...
      <div className="flex  flex-row p-12 card shadow-xl">
        ...
        <div className="flex gap-2 items-center">
          <PhoneIcon className="h-16 w-16 text-secondary" />
          <div>
        ...
        <div className="flex gap-2 items-center">
          <ClockIcon className="h-16 w-16 text-secondary" />
          <div>
        ...
        <div className="flex gap-2 items-center">
          <StarIcon className="h-16 w-16 text-secondary" />
          <div>
